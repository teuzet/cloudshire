...
Цель: полный LLM-генезис; агент-игрок каждый ход **обязан** `talk_to_ruler`, опционально `force_tick`; ориентир — **ambition/goals сценария**. Прогон до N тиков. Новости месяца — вольный пересказ, не дайджест.

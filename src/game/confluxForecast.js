 ...
 *
 * Прогноз здесь — не украшение, а копилка последствий пары: у сопряжения нет
 * концовок, и то, чем оно кончится, складывается из накопленного к расставанию.
 * Отсюда его и забирает финальная хроника.
 */
